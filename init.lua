...
-- Enable mouse mode and mouse mode key
vim.opt.mouse = 'a'
...
require('lazy').setup({
  ...
  --
  {
    'tpope/vim-fugitive', -- git fugitive plugin
    config = function()
      -- Custom keybindings for git.
      ...
      vim.api.nvim_set_keymap('n', '<leader>gr', ':Git rm<CR>', { noremap = true, silent = true, desc = 'git rm' })
